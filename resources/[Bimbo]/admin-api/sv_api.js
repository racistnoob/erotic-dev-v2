...
/* Configuration! */
const txAdminUrl = "127.0.0.1"; /* Set to you txAdmin hostname or IP */
const txAdminPort = 40120; /* Default is 40120.  */
const txAdminUsername = "anticheat" /* Set to a txAdmin user with ban permissions */
const txAdminPassword = 'B6uz$"8jH-qSeQk' /* Set to a txAdmin user with ban permissions */
