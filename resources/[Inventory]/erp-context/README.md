...
# Setup
It's pretty simple, once you drop the erp-context resource into your resources folder just make sure you put
...
RegisterCommand("test", function(source, args, raw)
    TriggerEvent("erp-context:testMenu")
end)

RegisterNetEvent('erp-context:testMenu', function()
...
RegisterNetEvent('erp-context:testMenu2', function(data)
    local id = data.id
...
# Support
Feel free to report any issues you have in the GitHub [Issues](https://github.com/nerohiro/erp-context/issues)

if you wish to add something to it, do a pull request on the github [Pull Requests](https://github.com/nerohiro/erp-context/pulls)
